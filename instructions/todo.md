...
- settings
    - timeout not less that 2 minutes validation
    - theme option


- don't logout automatically if in the middle of long operations like geerte recovery codes
or wipe, etc.

- about screen, build number etc
- warn if no more recovery codes are there.
- local mode (downlod the whole structure + screen for that)
